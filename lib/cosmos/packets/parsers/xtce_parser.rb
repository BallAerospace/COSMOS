...
module Cosmos
  ...
  class XtceParser
    ...
    def self.create_telemetry(xml, telemetry, target_name)
    ...
    def self.create_commands(xml, commands, target_name)
    ...
    def self.process_entry_list(xml, packet, cmd_vs_tlm)
    ...
    def self.set_fixed_value(xml, item)
