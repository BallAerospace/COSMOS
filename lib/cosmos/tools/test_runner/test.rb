...
module Cosmos
  ...
  # Base class for a test group. All COSMOS Test Runner tests should inherit Test
  # and then implement test cases as methods starting with 'test_', e.g. test_mech.
  class Test
  ...
  # Base class for Test Runner test suites. COSMOS Test Suites inherit from TestSuite
  # and can implement setup and teardown methods. Test groups are added via add_test(TestClass)
  # and individual test cases added via add_test_case(TestClass, test_case).
  class TestSuite
    attr_reader :tests
    attr_reader :plans
