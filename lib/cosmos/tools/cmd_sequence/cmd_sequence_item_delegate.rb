...
module Cosmos
  ...
  class CmdSequenceItemDelegate < Qt::StyledItemDelegate
    ...
    def createEditor(parent, option, index)
      packet_item, _, _ = SequenceItem.param_widgets[index.row]
      if index.column == 1 and packet_item and packet_item.states
        ...
        connect(combo, SIGNAL('activated(int)')) do
          ...
          SequenceItem.table.closeEditor(combo, 0)
        end
        return combo
      else
