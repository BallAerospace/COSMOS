...
spec = Gem::Specification.new do |s|
  s.name = 'openc3-demo'
  s.summary = 'OpenC3 Demo Targets'
  s.description = <<-EOF
    This plugin adds the OpenC3 demo configuration to a base OpenC3 installation.
    Install this to experiment with a configured OpenC3 system.
  EOF
