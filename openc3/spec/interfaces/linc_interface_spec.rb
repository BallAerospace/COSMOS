...
require 'spec_helper'
require 'openc3/interfaces/linc_interface'
  ...
  xdescribe LincInterface do
    ...
    describe "write" do
      ...
      it "adds to the ignored list upon an error ignore command" do
        cmd = System.commands.packet("INST", "OPENC3_ERROR_IGNORE")
      ...
      it "removes from the ignored list upon an error handle command" do
        ...
        cmd = System.commands.packet("INST", "OPENC3_ERROR_HANDLE")
        cmd.restore_defaults
        cmd.write("CODE", 0x66)
        @i.write(cmd)
      ...
      it "enables and disable handshakes upon command" do
        enable = System.commands.packet("INST", "OPENC3_HANDSHAKE_EN")
        enable.restore_defaults
        disable = System.commands.packet("INST", "OPENC3_HANDSHAKE_DS")
