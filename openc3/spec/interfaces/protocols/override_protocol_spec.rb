...
module OpenC3
  describe OverrideProtocol do
    ...
    xit "warns the user if the protocol is not required" do
      ...
      cts = File.join(OpenC3::USERPATH, 'config', 'tools', 'cmd_tlm_server', 'cmd_tlm_server.txt')
      FileUtils.mv cts, OpenC3::USERPATH
      ...
      FileUtils.mv File.join(OpenC3::USERPATH, 'cmd_tlm_server.txt'),
                   File.join(OpenC3::USERPATH, 'config', 'tools', 'cmd_tlm_server')
      System.class_eval('@@instance = nil')
    end
  end
end
