## COSMOS Tool Command Sender Plugin

[Documentation](https://ballaerospace.github.io/cosmos-website/)

This plugin provides the COSMOS Command Sender Tool

## Getting Started

1.  At the COSMOS Admin - Plugins, upload the cosmosc2-tool-cmdsender.gem file
