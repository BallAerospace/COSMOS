## COSMOS Tool Limits Monitor Plugin

[Documentation](http://cosmosrb.com)

This plugin provides the COSMOS Limits Monitor user interface

## Getting Started

1.  At the COSMOS Admin - Plugins, upload the cosmosc2-tool-limitsmonitor.gem file
